    ...
    var b = "custombox",
            ...
            return _createClass(a, null, [{
                ...
                value: function() {
                    ...
                    if (a.indexOf("Trident/") > 0) {
                        var c = a.indexOf("rv:");
                        return !isNaN(parseInt(a.substring(c + 3, a.indexOf(".", c)), 10))
                    }
                    var d = a.indexOf("Edge/");
                    return d > 0 && !isNaN(parseInt(a.substring(d + 5, a.indexOf(".", d)), 10))
                }
            }]), a
        }(),
        n = function() {
        ...
        r = function() {
            function a(c) {
                ...
                this.addSimpleClass(), this.element.style.animationDuration = this.options.content.speedIn + "ms", m.check(h, this.options.content.effect) && this.setAnimation()
            }
            return _createClass(a, [{
                key: "bind",
                value: function(a) {
                    var b = this;
                    return a === d && (m.check(h, this.options.content.effect) && this.setAnimation("animateTo"), this.element.classList.remove(c)), this.element.classList.add(a), new Promise(function(a) {
                ...
                value: function() {
                    ...
                    return new Promise(function(b) {
                        m.isIE() ? setTimeout(b, a.options.content.speedIn) : a.element.addEventListener("animationend", function() {
                            return b()
                        }, !0)
                    })
                }
                ...
                key: "setAnimation",
                value: function() {
                    for (var a = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : f, c = 0, d = g.length; c < d; c++) this.element.classList.contains(b + "-" + g[c]) && this.element.classList.remove(b + "-" + g[c]);
        ...
        s = function() {
            ...
            return _createClass(a, [{
                ...
                value: function(a) {
                    ...
                    switch (a) {
                        case d:
                            m.check(j, this.options.content.effect) && this.toggleAnimation("animateTo"), this.element.classList.add(d), this.element.classList.remove(c);
                            break;
                        default:
                ...
                value: function() {
                    var a = this;
                    return new Promise(function(b) {
                        m.isIE() ? setTimeout(b, a.options.overlay.speedIn) : a.element.addEventListener("animationend", function() {
                            return b()
                        }, !0)
                    })
                }
            ...
            return _createClass(a, [{
                ...
                value: function() {
                    ...
                    return new Promise(function(b, c) {
                        var d = a.options.content.target.match(/^.*(youtu\.be\/|v\/|u\/\w\/|embed\/|watch\?v=|\&v=)([^#\&\?]*).*/);
                        if (d && 11 == d[2].length) {
                            var e = document.createElement("div"),
                                f = document.createElement("iframe");
                            if (f.setAttribute("src", "https://www.youtube.com/embed/" + d[2] +
                                                      "?controls=0&rel=0&showinfo=0&modestbranding=1&autoplay=1"),
                                                      f.setAttribute("frameborder", "0"), f.setAttribute("allowfullscreen", ""), f.setAttribute("width", "100%"), f.setAttribute("height", "100%"), e.appendChild(f), !a.options.content.fullscreen) {
                                var g = window.innerWidth > 560 ? 560 : window.innerWidth,
                            ...
                            a.element.appendChild(e), b()
                        } else if ("#" !== a.options.content.target.charAt(0) && "." !== a.options.content.target.charAt(0)) {
                            var j = new XMLHttpRequest;
                            j.open("GET", a.options.content.target), j.onload = function() {
                                if (200 === j.status) {
                                    a.element.insertAdjacentHTML("beforeend", j.response);
                                ...
                                } else c(new Error(j.statusText))
                            }, j.onerror = function() {
                                return c(new Error("Network error"))
                            }, j.send()
                        } else {
                            var k = document.querySelector(a.options.content.target);
                            if (k) {
                                var l = k.cloneNode(!0);
                                l.removeAttribute("id"), l.style.display = "block", a.options.content.width && (l.style.flexBasis = a.options.content.width), a.element.appendChild(l), b()
            ...
            return _createClass(f, [{
                ...
                value: function() {
                    ...
                    this.build(), this.options.loader.active && this.loader.show(), this.content.fetch().then(function() {
                        m.check(l, a.options.content.effect) && (a.scroll = new n), a.options.overlay.active ? (a.dispatchEvent("overlay.onOpen"), a.overlay.bind(c).then(function() {
                            a.dispatchEvent("overlay.onComplete"), a.options.loader.active && a.loader.destroy()
                        })) : a.options.loader.active && a.loader.destroy(), a.container && a.container.bind(c), document.body.classList.add(e), a.content.bind(c).then(function() {
                            return a.dispatchEvent("content.onComplete")
                ...
                key: "build",
                value: function() {
                    this.options.loader.active && (this.loader = new q(this.options)), m.check(i, this.options.content.effect) && (this.container = new r(this.options)), this.options.overlay.active && (this.overlay = new s(this.options)), this.content = new t(this.options)
                }
            }, {
                key: "_close",
                value: function() {
