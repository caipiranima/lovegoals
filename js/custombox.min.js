                ...
                value: function() {
                    ...
                    return new Promise(function(b, c) {
                        ...
                        if (d && 11 == d[2].length) {
                            ...
                            if (f.setAttribute("src", "https://www.youtube.com/embed/" + d[2] + "?autoplay=1"), f.setAttribute("frameborder", "0"), f.setAttribute("allowfullscreen", ""), f.setAttribute("width", "100%"), f.setAttribute("height", "100%"), e.appendChild(f), !a.options.content.fullscreen) {
